...
export const { categoriesRequested, categoriesSuccess, categoriesFailed, newUserChatData, newUserRemoveChat, 
    filterData, articleId, setSliderLength, setIsproject, setLocationData } = momentSlice.actions;

...
export const GENERATE_RAZORPAY_ORDERID = "generate-razorpay-orderid";
...
// get payment detaisl
export const getPaymentDetials = (offset, limit, payment_type) => {
  return {
...
// FEATURE PROPERTY
export const featureProperty = (feature_for, property_id, project_id) => {
  let data = new FormData();
  if (feature_for) {
    data.append("feature_for", feature_for);
  }
  if (property_id) {
...
export const getAddedProjects = (slug_id, get_similar, offset, limit) => {
  let getuserid = getUserID();

  // Build params dynamically based on provided values
  const params = {};
  if (slug_id) params.slug_id = slug_id;
  if (get_similar) params.get_similar = get_similar;
  ...
  return {
    ...
    method: "GET",
    params,
    authorizationHeader: !!getuserid, // Simplified truthy check
  };
};
...
// GET home page api
export const getHomePage = (latitude, longitude, radius) => {
  let getuserid = getUserID();
  return {
    url: `${HOMEPAGE_DATA}`,
    method: "GET",
...
export const getPropertyList = (
  ...
  return {
    ...
    authorizationHeader: !!getuserid, // Shortened ternary check
  };
};
...
export const changeProjectStatus = (project_id, status) => {
  let data = new FormData();
  data.append("project_id", project_id);
  data.append("status", status);
  return {
...
export const generateRazorpayOrderId = (package_id) => {
  let data = new FormData();
  data.append("package_id", package_id);

  return {
    url: `${GENERATE_RAZORPAY_ORDERID}`,
    method: "POST",
    data,
    authorizationHeader: true,
  };
...
export const createAllPaymentIntent = (package_id, platform_type) => {
  let data = new FormData();
  data.append("package_id", package_id);
  data.append("platform_type", platform_type);
...
export const checkPackageLimit = (type) => {
  return {
    url: `${CHECK_PACKAGE_LIMIT}`,
    method: "GET",
    params: {
      type,
    },
...
export const getFeaturedData = (type, offset, limit) => {
  return {
    url: `${GET_FEATURED_DATA}`,
    method: "GET",
    params: {
      type,
      offset,
...
export const paymentTransactionFail = (payment_transaction_id) => {
  let data = new FormData();
  data.append("payment_transaction_id", payment_transaction_id);
  return {
    url: `${PAYMENT_TRANSACTION_FAIL}`,
    method: "POST",
    data,
    authorizationHeader: true,
  };
...
export const getPaymentReceipt = (payment_transaction_id) => {
  return {
...
export const initiateBankTransfer = (package_id, file) => {
  let data = new FormData();
  data.append("package_id", package_id);
  if (file) {
    data.append("file", file);
...
export const uploadBankReceiptFile = (payment_transaction_id, file) => {
  let data = new FormData();
  data.append("payment_transaction_id", payment_transaction_id);
  data.append("file", file);
  return {
    url: `${UPLOAD_BANK_RECEIPT_FILE}`,
    method: "POST",
    data,
    authorizationHeader: true,
  };
...
export const getAllSimilarProperties = (property_id, limit, offset, search) => {
  let getuserid = getUserID();
  return {
    url: `${GET_ALL_SIMILAR_PROPERTIES}`,
    method: "GET",
    params: {
      property_id,
      limit,
...
export const compareProperties = (source_property_id, target_property_id) => {
  let getuserid = getUserID();
  return {
    url: `${COMPARE_PROPERTIES}`,
    method: "GET",
    params: {
      source_property_id,
      target_property_id,
